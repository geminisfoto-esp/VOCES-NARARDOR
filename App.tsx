        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4 group">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest">Powered by Gemini 2.5</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:flex flex-col items-end text-[10px] font-medium text-slate-500 uppercase tracking-tighter">
              ...
              <span className="text-indigo-400/50">Model: v2.5-flash-tts</span>
            </div>
